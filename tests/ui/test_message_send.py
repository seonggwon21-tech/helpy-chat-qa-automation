"""
[TS-021] 메시지 전송 E2E 플로우 검증 (전송 버튼 클릭)
포함 TC: TC_008
"""
...
@allure.story("TS-021 · 메시지 전송 E2E 플로우 검증 (전송 버튼 클릭)")
class TestMessageSendFlow:
    ...
    def test_send_via_button_shows_ai_response(self, authenticated_driver):
        ...
        with allure.step("[TC_008] AI 응답 출력 완료 확인"):
